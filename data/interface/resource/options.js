config.options = {
  ...
  "scrollbarStyle": ["null", "simple", "native", "overlay"],
  "editor": {
    "new": undefined,
    "open": undefined,
    "save": undefined,
  ...
  "theme": [
    "paraiso-light", "tomorrow-night-bright", "zenburn", "bespin", "elegant", "lucario", "moxer", "pastel-on-dark",
    "3024-day", "cobalt", "gruvbox-dark", "material-darker", "neo", "rubyblue", "twilight", "3024-night", "colorforth",
    "lesser-dark", "midnight", "paraiso-dark", "the-matrix", "yonce", "base16-light", "eclipse", "liquibyte", "monokai",
    "ambiance-mobile", "duotone-dark", "isotope", "mdn-like", "panda-syntax", "ssms", "yeti", "base16-dark", "one-dark",
    "hopscotch", "material-ocean", "night", "seti", "vibrant-ink", "abcdef", "darcula", "icecoder", "material-palenight",
    "default", "tomorrow-night-eighties", "blackboard", "erlang-dark", "material", "neat", "railscasts", "duotone-light",
    "nord", "shadowfox", "xq-dark", "ambiance", "dracula", "idea", "mbo", "oceanic-next", "solarized", "xq-light", "ttcn",
    "ayu-dark", "ayu-mirage"
  ],
  "mode": [
  ...
  "codemirror": {
    ...
    get sidebarFontColor () {return config.storage.read("sidebarFontColor") !== undefined ? config.storage.read("sidebarFontColor") : "#C3C3C3"},
